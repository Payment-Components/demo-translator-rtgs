...
## SDK setup
Incorporate the SDK [jar](https://nexus.paymentcomponents.com/repository/public/gr/datamation/translator-rtgs/1.3.0/translator-rtgs-1.3.0-demo.jar)
...
Import the SDK
```groovy
implementation 'gr.datamation:translator-rtgs:1.3.0:demo@jar'
```
