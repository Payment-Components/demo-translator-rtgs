...
## SDK setup
Incorporate the SDK [jar](https://nexus.paymentcomponents.com/repository/public/gr/datamation/translator-rtgs/2.0.0/translator-rtgs-2.0.0-demo.jar)
...
Import the SDK
```groovy
implementation 'gr.datamation:translator-rtgs:2.0.0:demo@jar'
```
