...
## SDK setup
Incorporate the SDK [jar](https://nexus.paymentcomponents.com/repository/public/gr/datamation/translator-rtgs/3.4.0/translator-rtgs-3.4.0-demo.jar)
...
Import the SDK
```groovy
implementation 'gr.datamation:translator-rtgs:3.4.0:demo@jar'
```
